...
public class OpenGaussStatementLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"O", "P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y", "Z", "UL_", "ADMIN", 
			...
			"INT_", "HEX_", "IdentifierStartChar", "IdentifierChar", "StrictIdentifierChar"
		};
	}
	...
	public OpenGaussStatementLexer(CharStream input) {
		super(input);
