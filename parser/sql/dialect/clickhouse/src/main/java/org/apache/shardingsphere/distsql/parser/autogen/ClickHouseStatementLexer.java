...
public class ClickHouseStatementLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"O", "P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y", "Z", "UL_", "AFTER", 
			"ALIAS", "ANTI", "ASCENDING", "ASOF", "AST", "ASYNC", "ATTACH", "BOTH", 
			"CHECK", "CLEAR", "CLUSTER", "CODEC", "COLLATE", "COMMENT", "CUBE", "DATABASE", 
			"DATABASES", "DEDUPLICATE", "DELAY", "DESCENDING", "DESCRIBE", "DETACH", 
			"DICTIONARIES", "DICTIONARY", "DISK", "DISTRIBUTED", "END", "ENGINE", 
			"EVENTS", "EXPLAIN", "EXPRESSION", "EXTRACT", "FETCHES", "FINAL", "FIRST", 
			"FLUSH", "FOLLOWING", "FORMAT", "FREEZE", "GLOBAL", "GRANULARITY", "HIERARCHICAL", 
			"ID", "ILIKE", "INF", "INJECTIVE", "IS_OBJECT_ID", "KILL", "LAST", "LAYOUT", 
			"LEADING", "LIFETIME", "LIVE", "LOGS", "MATERIALIZE", "MATERIALIZED", 
			"MERGES", "MODIFY", "MOVE", "MUTATION", "NAN_SQL", "NO", "NULL_SQL", 
			"NULLS", "OPTIMIZE", "OUTFILE", "OVER", "PARTITION", "POPULATE", "PRECEDING", 
			"PREWHERE", "PROJECTION", "RANGE", "RELOAD", "REMOVE", "RENAME", "REPLACE", 
			"REPLICA", "REPLICATED", "ROLLUP", "ROW", "ROWS", "SAMPLE", "SEMI", "SENDS", 
			"SETTINGS", "SHOW", "SOURCE", "START", "STOP", "SYNC", "SYNTAX", "SYSTEM", 
			"TABLES", "TEMPORARY", "TEST", "TIES", "TIMEOUT", "TOP", "TOTALS", "TRAILING", 
			"TTL", "UNBOUNDED", "USE", "UUID", "VOLUME", "WATCH", "WINDOW", "ESCAPE", 
			"JSON_FALSE", "JSON_TRUE", "UINT8", "UINT16", "UINT32", "UINT64", "INT8", 
			"INT16", "INT32", "INT64", "FLOAT32", "FLOAT64", "STRING", "FIXED_STRING", 
			"DATETIME", "DATETIME64", "ENUM8", "ENUM16", "TUPLE", "IPV4", "IPV6", 
			"NESTED", "NULLABLE", "ZERO_", "ONE_", "TWO_", "THREE_", "FOUR_", "FIVE_", 
			"SIX_", "SEVEN_", "EIGHT_", "NINE_", "IDENTIFIER_", "STRING_", "NUMBER_", 
	...
	public ClickHouseStatementLexer(CharStream input) {
		super(input);
