...
public class FirebirdStatementLexer extends Lexer {
	...
	public static final int
		...
		STRING_=415, NUMBER_=416, HEX_DIGIT_=417, BIT_NUM_=418;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"BLOCK_COMMENT", "INLINE_COMMENT", "AND_", "CONCAT_", "NOT_", "TILDE_", 
			...
			"O", "P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y", "Z", "UL_", "HYPHEN", 
	...
	public FirebirdStatementLexer(CharStream input) {
		super(input);
